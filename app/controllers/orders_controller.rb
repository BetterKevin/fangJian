class OrdersController < ApplicationController
  before_action :set_order, only: [:show, :edit, :update, :destroy, :checkout, :add_item, :delete_item]
  ...
  def checkout
    ...
    @order.cost = Order.time_price(@order.difftime, @order.start_time.to_datetime.wday, @order.start_time.to_datetime.hour, @order.start_time.to_datetime.min)
    @order.save
    redirect_to orders_url
  end
